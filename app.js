const quize = [
  {
    question:'『名探偵コナン』の主人公、江戸川コナンの決め台詞は次のうちどれでしょう？',
    answers: [
      '真実はいつも一つ', 
      '解けない謎はない', 
      'この町の謎は俺が解いてやる', 
    ...
    question:'『ONE　PIECE（ワンピース）』の主人公、モンキー・D・ルフィが食べた悪魔の実は次のうちどれでしょう？',
    answers: [
      'ハナハナの実',
      'ヒトヒトの実',
      'ゴムゴムの実',
    ...
    question:'『機動戦士ガンダム』の主人公アムロ・レイがホワイトベース内でブライト・ノアに顔を殴られたときに言ったセリフはどれでしょう？',
    answers: [
    ...
    question:'『魔女の宅急便』の主人公、キキは何に乗って空を飛ぶでしょうか？',
    answers: [
      '箒（ほうき）',
      '物干し竿',
      '紙飛行機',
    ...
    question:'『ルパン三世』の主人公、ルパン三世が愛用する拳銃は次のうちどれでしょう？',
    answers: [
      'ワルサーP36',
      'ワルサーP37',
      'ワルサーP38',
    ...
    question:'『となりのトトロ』で、草壁家に住んでいた家じゅうをすすと灰だらけにしてしまう生き物の名前はどれでしょう？',
    answers: [
      'まっしろしろすけ',
      'まっくろくろすけ',
      'くろちゃん',
    ...
    question:'『天空の城ラピュタ』で、物語の終盤にパズーとシータが一緒に唱える滅びの呪文はどれでしょう？',
    answers: [
      'パズル',
      'パルス',
      'バルス',
